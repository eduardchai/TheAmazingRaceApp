namespace TheAmazingRace.DAL.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ChallengeDescription = c.String(nullable: false),
            ...
            CreateTable(
                "dbo.RaceEventPitStopTeam",
                c => new
                    {
                        RaceEventId = c.Int(nullable: false),
                        TeamId = c.Int(nullable: false),
                        NoOfCompletedStop = c.Int(nullable: false),
                        PitStopId = c.Int(),
                        CompletedOn = c.DateTime(),
                    })
                .PrimaryKey(t => new { t.RaceEventId, t.TeamId, t.NoOfCompletedStop })
                .ForeignKey("dbo.PitStop", t => t.PitStopId)
                .ForeignKey("dbo.RaceEvent", t => t.RaceEventId, cascadeDelete: true)
                ...
                c => new
                    {
                        RaceEventId = c.Int(nullable: false),
                        UserId = c.String(nullable: false, maxLength: 128),
                        CurrentLong = c.Double(),
                        CurrentLat = c.Double(),
                    })
                .PrimaryKey(t => new { t.RaceEventId, t.UserId })
                .ForeignKey("dbo.RaceEvent", t => t.RaceEventId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserId, cascadeDelete: true)
                .Index(t => t.RaceEventId)
                .Index(t => t.UserId);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.TeamId, t.PitStopId })
                .ForeignKey("dbo.PitStop", t => t.PitStopId, cascadeDelete: true)
                .ForeignKey("dbo.Team", t => t.TeamId, cascadeDelete: true)
                .Index(t => t.TeamId)
                .Index(t => t.PitStopId);
        ...
        {
            DropForeignKey("dbo.TeamPitStop", "TeamId", "dbo.Team");
            DropForeignKey("dbo.TeamPitStop", "PitStopId", "dbo.PitStop");
            DropForeignKey("dbo.AspNetUserRoles", "RoleId", "dbo.AspNetRoles");
            DropForeignKey("dbo.RaceEventUser", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.RaceEventUser", "RaceEventId", "dbo.RaceEvent");
            DropForeignKey("dbo.RaceEventPitStopTeam", "TeamId", "dbo.Team");
            DropForeignKey("dbo.RaceEventPitStopTeam", "RaceEventId", "dbo.RaceEvent");
            DropForeignKey("dbo.RaceEventPitStopTeam", "PitStopId", "dbo.PitStop");
            ...
            DropIndex("dbo.TeamPitStop", new[] { "PitStopId" });
            DropIndex("dbo.TeamPitStop", new[] { "TeamId" });
            DropIndex("dbo.AspNetRoles", "RoleNameIndex");
            DropIndex("dbo.RaceEventUser", new[] { "UserId" });
            DropIndex("dbo.RaceEventUser", new[] { "RaceEventId" });
            DropIndex("dbo.RaceEventPitStopTeam", new[] { "PitStopId" });
            DropIndex("dbo.RaceEventPitStopTeam", new[] { "TeamId" });
            DropIndex("dbo.RaceEventPitStopTeam", new[] { "RaceEventId" });
            ...
            DropTable("dbo.TeamPitStop");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.RaceEventUser");
            DropTable("dbo.RaceEventPitStopTeam");
